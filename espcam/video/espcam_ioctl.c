...
static int espcam_vidioc_querycap(struct file *file, void *priv, struct v4l2_capability *cap)
{
...
static int espcam_vidioc_enum_fmt(struct file *file, void *fh, struct v4l2_fmtdesc *fmt)
{
...
static int espcam_vidioc_g_input(struct file *file, void *fh, unsigned int *input)
{
	*input = 0;
...
static int espcam_vidioc_g_parm(struct file *file, void *fh, struct v4l2_streamparm *parm)
{
	struct espcam_video *dev = video_drvdata(file);
...
static int espcam_vidioc_s_parm(struct file *file, void *fh, struct v4l2_streamparm *parm)
{
	struct espcam_video *dev = video_drvdata(file);
...
const struct v4l2_ioctl_ops espcam_ioctl_ops = {
	.vidioc_querycap = espcam_vidioc_querycap,
	.vidioc_enum_fmt_vid_cap = espcam_vidioc_enum_fmt,
	.vidioc_g_fmt_vid_cap = espcam_vidioc_g_fmt,
	.vidioc_s_fmt_vid_cap = espcam_vidioc_s_fmt,
	.vidioc_try_fmt_vid_cap = espcam_vidioc_try_fmt,
	...
	.vidioc_enum_input = espcam_vidioc_enum_input,
	.vidioc_g_input = espcam_vidioc_g_input,
	.vidioc_g_parm = espcam_vidioc_g_parm,
	.vidioc_s_parm = espcam_vidioc_s_parm,
};
